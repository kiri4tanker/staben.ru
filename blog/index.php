...
$APPLICATION->SetPageProperty("description", "Статьи по электростанциям от компании Стабильная Энергия. Наш телефон в Москве: +7 (495) 789-49-43.");
$APPLICATION->SetPageProperty("title", "Статьи о бензо-дизель-газогенераторах | Компания «Стабильная Энергия»");
$APPLICATION->SetPageProperty("keywords", "Электростанции статьи");
