		...
		<div class="region_wrapper">
			<div class="io_wrapper">
				...
				<?if (
					...
					<div class="js_city_chooser  animate-load  io_wrapper" data-event="jqm" data-name="city_chooser_small" data-param-href="<?=$arResult['URI'];?>" data-param-form_id="city_chooser">
