...
<?if (
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
        <thead><tr><td colspan="2"><h4><?=GetMessage('subscr_title_auth2');?></h4></td></tr></thead>
        <tr valign="top">
            <td width="40%">
                <p><?=GetMessage('adm_auth1');?> <a href="<?=SITE_DIR;?>auth/?backurl=<?=SITE_DIR;?>personal/subscribe/<?/* echo $arResult["FORM_ACTION"]?>?authorize=YES&amp;sf_EMAIL=<?echo $arResult["REQUEST"]["EMAIL"]?><?echo $arResult["REQUEST"]["RUBRICS_PARAM"] */?>"><?=GetMessage('adm_auth2');?></a>.</p>
                <?if ($arResult['ALLOW_REGISTER'] == 'Y'):?>
                    <p><?=GetMessage('adm_reg1');?> <a href="<?=SITE_DIR;?>auth/registration/?backurl=<?=SITE_DIR;?>personal/subscribe/<?/* echo $arResult["FORM_ACTION"]?>?register=YES&amp;sf_EMAIL=<?echo $arResult["REQUEST"]["EMAIL"]?><?echo $arResult["REQUEST"]["RUBRICS_PARAM"] */?>"><?=GetMessage('adm_reg2');?></a>.</p>
                <?endif;?>
            </td>
        </tr>
    </table>
    ...
    <form action="<?=$arResult['FORM_ACTION'];?>" method="post">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
            <thead>
                <tr>
                    <td colspan="2">
                        <h4><?=GetMessage('adm_auth_exist');?></h4>
                    </td>
                </tr>
            </thead>
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        <input type="submit" name="Save" value="<?=GetMessage('adm_auth_butt');?>" />
                    </td>
                </tr>
            </tfoot>
        </table>
        ...
        <form action="<?=$arResult['FORM_ACTION'];?>" method="post">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
                ...
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <input type="submit" name="Save" value="<?=GetMessage('adm_reg_butt');?>" />
                        </td>
                    </tr>
                </tfoot>
            </table>
