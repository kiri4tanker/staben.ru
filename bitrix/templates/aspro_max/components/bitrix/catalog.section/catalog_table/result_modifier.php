...
if (!empty($arResult['ITEMS'])) {
    ...
    if ($arResult['MODULES']['catalog']) {
        ...
        if ($arParams['TYPE_SKU'] == 'TYPE_1' && $bShowOfferTree) {
    ...
    foreach ($arResult['ITEMS'] as $key => $arItem) {
        ...
        $arResult['ITEMS'][$key]['ADD_TO_BASKET_DATA'] = CMax::GetAddToBasketArray($arItem, $arResult['ITEMS'][$key]['TOTAL_COUNT'], $arParams['DEFAULT_COUNT'], $arParams['BASKET_URL'], false, [], 'small', $arParams);
    ...
    if ($arResult['COLS_PROP']) {
        Collection::sortByColumn($arResult['COLS_PROP'], [
