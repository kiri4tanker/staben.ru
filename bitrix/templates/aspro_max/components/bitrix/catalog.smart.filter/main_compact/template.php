                ...
                <div class="bx_filter_parameters">
                    ...
                    foreach ($arResult["ITEMS"] as $key => $arItem) {
                        if (isset($arItem["ASPRO_FILTER_SORT"]) && $arItem["VALUES"]) {
                            ...
                            ?>
                            <div class="bx_filter_parameters_box bx_sort_filter visible-xs <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code="<?=strtolower($arItem["CODE"]);?>" data-prop_inline="<?=($arItem['IS_PROP_INLINE'] ? 'prop_inline' : '')?>" data-property_id="<?=$arItem["ID"]?>">
                    ...
                    foreach ($arResult["ITEMS"] as $key=>$arItem)
                    {
                        ...
                        <div class="bx_filter_parameters_box prop_type_<?=$arItem["PROPERTY_TYPE"];?><?=(isset($arItem['PROPERTY_SET']) && $arItem['PROPERTY_SET'] == 'Y' ? ' set' : '');?>" data-prop_code="<?=strtolower($arItem["CODE"]);?>" data-prop_inline="<?=($arItem['IS_PROP_INLINE'] ? 'prop_inline' : '')?>" data-property_id="<?=$arItem["ID"]?>">
                            ...
                            <div class="bx_filter_block <?=($arItem['IS_PROP_INLINE'] ? "limited_block" : "");?>" <?=$style;?>>
                                ...
                                <div class="bx_filter_parameters_box_container <?=($arItem["DISPLAY_TYPE"]=="G" ? "pict_block" : "");?> <?=(!$arItem['IS_PROP_INLINE'] && $arItem["DISPLAY_TYPE"] != 'A' ? 'scrollblock scrollblock--ob-auto' : '');?>">
                                <?
                                ...
                                switch ($arItem["DISPLAY_TYPE"]) {
                                    ...
                                    default://CHECKBOXES
                                        ...
                                        <?foreach ($arItem["VALUES"] as $val => $ar):?>
                                            ...
                                            <div class="filter label_block filter-value-wrap <?= ($count < 2) ? 'single' : ''?> <?=$bHint ? 'props-hint' : ''?>">
                                            <input
                                                type="checkbox"
