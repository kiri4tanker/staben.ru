...
<script type="text/javascript">
	...
	<div style="position:relative; display: block; width:100%;">
            ...
            <?if($showLicence == 'Y'):?>
                ...
                TSolution\Functions::showBlockHtml([
                    ...
                    'PARAMS' => [
                        ...
                        'SUBMIT_TEXT' => GetMessage('OPINIONS_SEND'),
                        'REPLACE_FIELDS' => [],
		...
		<div class="reviews-reply-buttons">
			<button name="send_button" type="submit" class="btn btn-default reviews-reply-buttons__send" tabindex="<?=$tabIndex++;?>" <?
...
\Aspro\Max\Functions\Extensions::init('validate');
?>

<script>
BX.Aspro.Utils.readyDOM(() => {
    $('form[name="<?=$arParams["FORM_ID"];?>"]').validate();
});
</script>
