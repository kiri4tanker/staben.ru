        ...
        <?else:?>
            <div class="form">
                <form id="registraion-page-form" method="post" action="<?=POST_FORM_ACTION_URI;?>" name="regform" enctype="multipart/form-data" >
                    <div class="top-text">
                        <?$APPLICATION->IncludeFile(SITE_DIR.'include/register_description.php', [], ['MODE' => 'html', 'NAME' => '']);?>
                    </div>
                    ...
                    <div class="form_body">
                        ...
                        <?if ($arResult['USE_CAPTCHA'] === 'Y'):?>
                            ...
                            <div class="form-control captcha-row clearfix">
                                <label><span><?= $captcha->isService() && $captcha->isActive() ? GetMessage('FORM_GENERAL_RECAPTCHA') : GetMessage('REGISTER_CAPTCHA_PROMT');?>&nbsp;<span class="star">*</span></span></label>
                                <div class="captcha_image">
                                    <img data-src src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult['CAPTCHA_CODE'];?>" class="captcha_img">
