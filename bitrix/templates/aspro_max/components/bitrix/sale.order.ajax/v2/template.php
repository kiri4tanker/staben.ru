...
$APPLICATION->AddViewContent('more_text_title', '<div class="basket-back font_xs"><a href="'.TSolution::GetFrontParametrValue('BASKET_PAGE_URL').'" class="basket-back__link muted">'.Loc::getMessage('GO_TO_BASKET').'</a></div>');
?>
    <NOSCRIPT>
...
if (strlen($request->get('ORDER_ID')) > 0) {
    ...
    <script>
        ...
        $city = Bitrix\Sale\Location\TypeTable::getList(['filter' => ['=CODE' => 'CITY'], 'select' => ['ID']])->fetch();
        ?>
