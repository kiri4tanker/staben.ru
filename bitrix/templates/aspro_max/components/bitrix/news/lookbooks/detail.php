...
$arElement = TSolution\Cache::CIblockElement_GetList(['CACHE' => ['TAG' => TSolution\Cache::GetIBlockCacheTag($arParams['IBLOCK_ID']), 'MULTI' => 'N']], $arItemFilter, false, false, ['ID', 'NAME', 'PREVIEW_TEXT', 'IBLOCK_SECTION_ID', 'DETAIL_PICTURE', 'DETAIL_PAGE_URL', 'PROPERTY_LINK_GOODS', 'PROPERTY_SECTION', 'PROPERTY_FILTER_URL', 'PROPERTY_H3_GOODS', 'PROPERTY_COLLECTION_TEMPLATE', 'ElementValues']);

$bHideBackUrl = false;

if ($arElement && $arElement['PROPERTY_COLLECTION_TEMPLATE_ENUM_ID']) {
    $arDisplayRes = CIBlockPropertyEnum::GetList(['DEF' => 'DESC', 'SORT' => 'ASC'], ['ID' => $arElement['PROPERTY_COLLECTION_TEMPLATE_ENUM_ID']]);
        ...
        <?if ($arElement):?>
            <?$this->SetViewTarget('product_share');?>
                <?if ($arParams['USE_SHARE'] == 'Y'):?>
                    <?TSolution\Functions::showShareBlock('top');?>
                <?endif;?>
