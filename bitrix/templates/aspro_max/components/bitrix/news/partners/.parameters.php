...
if (Bitrix\Main\Loader::includeModule('iblock')) {
    ...
    while ($arProp = $rsProp->Fetch()) {
        if ($arProp['PROPERTY_TYPE'] != 'F') {
            $arProperty[$arProp['CODE']] = '['.$arProp['CODE'].'] '.$arProp['NAME'];
        } else {
            $arPropertyF[$arProp['CODE']] = '['.$arProp['CODE'].'] '.$arProp['NAME'];
        }
    }
...
if (strpos($viewTemplate, 'with_group') !== false) {
    ...
    $arTemplateParameters['MOBILE_BORDERED'] = [
        'NAME' => GetMessage('T_MOBILE_BORDERED'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y',
        'PARENT' => 'LIST_SETTINGS',
    ];
    $arTemplateParameters['COLORED_IMG'] = [
    ...
    $arTemplateParameters['SIDE_LEFT_BLOCK'] = [
        'PARENT' => 'BASE',
    ...
    $arTemplateParameters['TYPE_LEFT_BLOCK'] = [
        'PARENT' => 'BASE',
    ...
    $arTemplateParameters['SHOW_SORT_IN_FILTER'] = [
